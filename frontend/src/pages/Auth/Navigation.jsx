...
//       } xl:flex lg:flex md:hidden sm:hidden flex-col justify-between p-4 text-white bg-gray-600 w-[10%] hover:w-[15%] h-[100vh]  fixed `}
...
const Navigation = () => {
  ...
  return (
    <div className="navigation-container min-h-[20px]">
      ...
      <div className="navigation-user">
        ...
        {!userInfo && (
          <ul className="login-register mr-64">
            <li>
